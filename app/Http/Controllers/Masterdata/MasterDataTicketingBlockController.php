...
class MasterDataTicketingBlockController extends Controller
{
    ...
    public function createTicketingBlock(Request $request)
    {
        try {
            ...
            if ($request->ticketing_type_name == 'Armada'){
                $ticketing_block->mutasi_block_day      = $request->mutasi_block_day;
                $ticketing_block->max_mutasi_block_day  = $request->max_mutasi_block_day;
            }else{
                $ticketing_block->mutasi_block_day      = null;
                $ticketing_block->max_mutasi_block_day  = null;
            }
    ...
    public function resetTicketingBlock()
    {
        try {
            ...
            $armada_block->mutasi_block_day          = 15;
            $armada_block->max_mutasi_block_day      = 15;
