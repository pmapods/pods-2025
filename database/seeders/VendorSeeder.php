...
class VendorSeeder extends Seeder
{
    ...
    DB::unprepared("
        INSERT INTO vendor(code, name, address, city_id, salesperson, phone) VALUES
        ...
        ('V100100311','MAKMUR ARTHA SEJAHTERA  PT.','25 RUKO TOHO BLOK. B NO 25 PANTAI I',3172,'Budi ','+62 812-1866-1418'),
        ('V100100312','ELLEAIR INTERNATIONAL TRADING INDON','WISMA BNI 46 KOTA BNI LT.15 JL. JEN',3173,'Beryl ','+62 811-8751-591'),
        ('V100100313','STANLI TRIJAYA MANDIRI  PT.','115 Jl. Terusan Kopo Km.11,5 Kawasa',3273,'Nita','+62 896-9968-7752'),
        ('V100100501','MAKMUR MANDIRI PRATAMA  PT','JL. KEBON KANGKUNG NO 181 - 182',3273,'Meindra Pratama','0895-1729-6343'),
        ('V100100503','SAYAP MAS UTAMA  PT','JL L. TIPAR CAKUNG KAV. F 5-7, C',3172,'Ellya Maron Sandi','0857-0100-0305'),
        ...
        ('V100100516','MAHAMERU MEKAR DJAYA  PT','JL. SOEKARNO HATTA NO.736',3273,'RYAN RIZKI NUGRAHA','0812-14360939'),
        ('V100100517','NUTRIBEV SINERGY INDONESIA','JL. SOEKARNO HATTA NO.112',3273,'Niki ','0815-8509-1484'),
        ('V100300592','PRATESIS  PT.','1 JL. MAMPANG PRAPATAN RAYA',3171,'HANJONO','085273535030'),
        ('V100300713','Electronic Smart Solution','7 JL. PINANGSIA RAYA PLAZA PINANGSI',3174,'TITIN','08174899985'),
        ...
        ('V100301143','LINUXINDO  PT.','28 JL. LETJEND S.PARMAN KAV.28',3173,'HERAWATI','0818179199'),
        ('V100301482','PIONEER KREASI  PT.','33 JL. TOMANG RAYA JAKARTA BARAT',3174,'HENDRA','085811835253'),
        ('V100301528','ALTROS TEKNOLOGI  PT.','43 JL. BANDENGAN SELATAN',3175,'MARIA','085782821992'),
        ('V100301564','ADDROO SOFTWARE TRANSFORMA  PT.','23 PERKANTORAN PREMIER VILLAGE M',3671,'RANGGA','08111807890'),
        ('V100301595','INOV PERDANATEKNOLOGI  PT.','6 JL.TEUKU NYAK ARIEF BLOK CC CC NO',3171,'AYU TRIASTUTI','81315036591'),
        ('V100301609','GTI  TK.','8 JL.GALAXY RAYA RUKO PORIS CEN',3671,'META','087878786978'),
        ...
        ('V100600042','INDOCARE PACIFIC  PT.','22-24 JL. S. Parman Kav. 22-24 Slip',3174,'RIZKY','81283826584'),
        ...
        ('V100600536','JALUR NUGRAHA EKAKURIR  PT.','11 JL. TOMANG RAYA',3174,'Arini ','+085643906260'),
        ...
        ('V100600673','CAKRA SATYA INTERNUSA  PT.','20-21 BUSINESS PARK KALIDERES  CITY',3174,'ANNAN','087777807654'),
        ('V100600680','INDONESIA COMNETS PLUS  PT.','58 JL. SUPRATMAN',3273,'IRAWATI','081322806209'),
        ('V100600695','MITRA PINASTHIKA MUSTIKA RENT  PT.','10 JL. KPT SOEBIJANTO DJOJOHADIKUSU',3671,'EMILIA','081281088902'),
        ...
        ('V100600845','CANDRA PERKASA MANDIRI  PT.','9 JL. CEMARA PONDOK RANJI BINTARO',3674,'TITIS','087888215685'),
        ('V100600971','MULIAFORM GRAFIDO  PT.','20 KWS. IND. CANDI BLOK 20 A',3322,'NITA','082116754208'),
        ('V100601008','MULTIGRAFIKA GLOBAL  PT.','88 JL. SULTAN ISKANDAR MUDA',3171,'Lukas Suteja ','021-72789482'),
        ('V100601063','ADIDAYA PRATAMA INDONESIA  PT.','41 BELTWAY OFFICE PARK TOWER B LT.5',3173,'RANGGA','08111807890'),
        ('V100601168','BUDI MAKMUR  TK.','220 PASAR INDUK CARINGIN JL. SOEKAR',3273,'MARYAM','089517048626'),
        ('V100601169','MITRA SENTOSA ABADI  CV.','88 RUKO MATAHRAI SQUARE BALEENDAH',3204,'Edi','0877-2211-9022'),
        ...
        ('V100601322','MARDIKA DAYA TRIBUANA  PT.','194 JL. MELAWAI RAYA BLOK III',3171,'AULIA','081285960493'),
        ('V100601344','GIANNE KONVEKSI  CV.','9 PERUM BANDUNG INTEN INDAH BLOK B9',3273,'ANDYANA','08112253007'),
        ...
        ('V100601377','BATAVIA PROSPERINDO TRANS  PT.','19 RUKO GOLDEN BOULEVARD BLOK P',3671,'ERICH','089626518974'),
        ('V100601420','GLOBAL MAJU BERSAMA  PT.','15 RUKO BIDEX BLOK C BSD TANGSEL',3671,'MICHAEL','08111207418'),
        ('V100601441','PT. SIGMA AKTUARINDO','Jl. Raya Merua Ilir Jakarta Barat',3173,'Iwan','+87885365949'),
        ('V100601479','WIN TEKNIK  CV.','5 JL. BITUNG RAYA',7172,'VANNA','081295558626'),
        ('V100601563','ADDROO HURES TRANSFORMA  PT.','23 PERKANTORAN PREMIER VILLAGE BLOK',3671,'RANGGA','08111807890'),
        ('V100601565','BISTEM JAYA MANDIRI','36 JL H TAIMAN RAYA',3173,'RETNO DAMAYANTI','081234355612'),
        ('V100601566','PT. PROGRESS CITRA SEMPURNA','2/001 99 BUILDING, JL. MAMPANG PRAP',3171,'ANGGA','08111703518'),
        ('V100601567','AGUNG SOLUSI TRANS  PT','14 JL CUT MUTIAH',3173,'DENNY HARDLAN','0812-1970-5555'),
        ('V100601580','BUREAU VERITAS INDONESIA  PT.','1 JL.HR RASUNA SAID KAV B1 WISMA BA',3173,'JOLANDA','081385841231'),
        ('V100601581','PREMYSIS  PT.','51 JL.MEGA KUNINGAN LOT',3171,'FERDINAN','08119003094'),
        ('V100601610','AZZURA JAYA MANDIRI  PT.','18 JL. KEMBANG SETAMAN KAVLING A UN',3173,'SOLIHIN','08111919745'),
        ('V100601640','RENTOKIL INDONESIA  PT.','8 JL. R.A. KARTINI KAV',3173,'Novi','0813-8467-0455'),
        ...
        ('V100601677','ARMADA AUTO TARA  PT.','9 JL. M.H. THAMRIN CIKOKOL',3671,'FITRIANI','081287316299'),
        ('V100601679','SRIKANDI DIAMOND MOTORS  PT.','33 JL. BHARATA RAYA PERUMNAS',3215,'SUSAN','081298741919'),
        ('V100601680','PAJA RAYA MOTOR  PT.','36 JL. DAAN MOGOT TANGERANG',3671,'APRIL','0818847162'),
        ...
        ('V100601689','AMIDIS TIRTA MULIA  PT.','273 JL. RAYA CIMAREME NGAMPRAH',3217,'Ujang','0813-1835-2785'),
        ...
        ('V100601703','BINTANG AUTO SEMESTA  PT.','2.5 JL. GATOTSUBROTO CIMONE',3671,'Wendi','0852-8469-5758'),
        ...
        ('V100601830','MARSH INDONESIA  PT','16 - 17 GED. WTC LT, 16 - 17',3172,'Basuki','0812-9048-5230'),
        ...
        ('V100601995','SEJAHTERA BUANA TRADA  PT.','405 JL. RAYA SERPONG SEKTOR VIII BL',3671,'CHEPPY','82111145693'),
        ('V100602018','KKB BCA','10 JL. METRO PONDOK INDAH',3171,'HILMAN','82318274160'),
        ('V100608032','Astra Daihatsu Serpong  PT.','Perum BCD Blok 405/2A Sektor 8 Serp',3671,'Marcello','81958660193'),
        ('V100608035','Honda Permata Serpong','Jl. Boulevard gading serpong CBD Lo',3671,'Ellen','81298908555'),
        ('V100608036','Auto 2000 Cirebon','14 Jl. Bridgen Darsono',3209,'Edwin','81220378251'),
        ('V100608037','KAS NEGARA','1 INDONESIA',3171,'-','-'),
        ...
        ('V100608045','TUNAS REDEAN Tbk  PT.','80 JL. RAYA MERDEKA CIMONE',3671,'FELICIA','0812-1311-3189'),
        ('V100608046','TUNAS MOBILINDO PERKASA  PT','88 JL RAYA DAAN MOGOT KM 23',3671,'Hermawan','0812-9358-4594'),
        ('V100608047','AKITA PRIMA MOBILINDO  PT','1 JL IMAM BONJOL',3671,'ALFHINCIO','081290766033'),
        ('V100608048','KELOLA JASA ARTHA  PT.','28 JL. I.R H JUANDA NO. 28 JAKARTA',3173,'DEDY ARDIASNYAH','0811-9485-72'),
        ...
        ('V100608100','WIJAYA TOYOTA DAGO','131 JL IR H JUANDA DAGO BANDUNG',3273,'ESIH SUKAESIH','0823-1611-1547'),
        ...
        ('V100608110','ISTANA KEMAKMURAN MOTOR  PT','22 JL HOS COKROAMINOTO',3671,'Lucky','081383403402'),
        ...
        ('V100608125','DIPO INTERNASIONAL PAHALA OTOMOTIF ','36 JL DAAN MOGOT',3671,'APRIL','0818-847-162'),
        ...
        ('V100608135','SRIKANDI DIAMOND MOTOR  PT','197 JL KH HASYIM ASHARI',3671,'ELVIN','0811-1576-688'),
