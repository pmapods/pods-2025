    ...
    <script>
        ...
        function reviseBudgetUpload(upload_budget_id){
            ...
            $('#template_table tbody tr').each(function(index){
                ...
                append_input_text += "<input type='hidden' name='item["+index+"][type_armada]' value='"+code+"'>";
                append_input_text += "<input type='hidden' name='item["+index+"][vendor]' value='"+keterangan+"'>";
            ...
            $('#submitform').prop('action', '/armadabudget/reviseBudget');
