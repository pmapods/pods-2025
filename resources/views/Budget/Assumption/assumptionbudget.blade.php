...
<div class="content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Assumption Budget</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item">Budget</li>
                    <li class="breadcrumb-item active">Assumption Budget</li>
                </ol>
            </div>
        </div>
        <div class="d-flex justify-content-end mt-4">
            <a href="/assumptionbudget/create" class="btn btn-primary">Tambah Budget Baru</a>
        </div>
    </div>
</div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#budgetDT tbody').on('click', 'tr', function () {
                ...
                window.location.href="/assumptionbudget/"+code;
            });
        })
    </script>
@endsection
