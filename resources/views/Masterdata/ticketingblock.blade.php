            ...
            <table class="table table-bordered table-striped dataTable" role="grid" id="ticketingBlockTable">
                <thead>
                    <tr>
                        ...
                        <th>Mutasi Block Day</th>
                        <th>Max Mutasi Block Day</th>
                        <th>Dibuat Oleh</th>
                ...
                <tbody>
                    @foreach ($ticketing_blocks as $ticketing_block)
                        <tr>
                            ...
                            <td>{{ $ticketing_block->mutasi_block_day }}</td>
                            <td>{{ $ticketing_block->max_mutasi_block_day }}</td>
                ...
                <form action="/ticketingblocking/create" method="post">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="required_field"l>Mutasi Block Day</label>
                                    <input type="number" class="form-control" name="mutasi_block_day" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="required_field"l>Max Mutasi Block Day</label>
                                    <input type="number" class="form-control" name="max_mutasi_block_day" required>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            $('#ticketingBlockTable tbody').on('click', 'tr', function() {
                ...
                let mutasi_block_day = $(this).find('td:eq(7)').text().trim();
                let max_mutasi_block_day = $(this).find('td:eq(8)').text().trim();
                ...
                $('input[name="mutasi_block_day"]').val(mutasi_block_day);
                $('input[name="max_mutasi_block_day"]').val(max_mutasi_block_day);
