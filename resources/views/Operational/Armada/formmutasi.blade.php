                ...
                <tr>
                    @foreach($mutasiform->authorizations as $authorization)
                        <td width="{{ 100/$count }}%" class="align-bottom small" style="height: 80px">
                            @if (($mutasiform->current_authorization()->employee_id ?? -1) == $authorization->employee_id)
    ...
    <form id="formmutasi" method="post" action="/addmutasiform">
        ...
        <div class="border p-2 border-dark">
            ...
            <table class="table table-bordered table-sm">
                <tbody>
                    <tr>
                        <td width="25%" class="required_field">No. BA Mutasi</td>
                        <td width="75%" colspan="3">
                            <input type="text" class="form-control form-control-sm" value="akan dibuat oleh sistem" readonly>
                        </td>
                    </tr>
                    <tr>
                        <td width="25%" class="required_field">PMA Pengirim</td>
                            ...
                            <select class="form-control select2" name="receive_salespoint_id" required>
                                ...
                                @foreach ($salespoints as $salespoint)
                                    <option value="{{ $salespoint->id }}"
                                        @if ($armadaticket->salespoint_id == $salespoint->id)
                                            disabled
                                        @endif>{{ $salespoint->name }}</option>
                                @endforeach
                            </select>
                            </div>
                        </td>
            ...
            <div class="row">
                ...
                <div class="col-4 small py-2 required_field"><i class="fa fa-circle fa-xs mr-1" style="font-size : 0.5rem" aria-hidden="true"></i>Tahun Pembuatan</div>
                <div class="col-8">
                    <input type="number" class="form-control form-control-sm autonumber" 
                    min="1970" max="{{ now()->format('Y') }}"
            ...
            <div class="row">
                ...
                <div class="col-8 py-2">
                    <div class="d-flex small align-items-center">
                        <input type="radio" class="mr-1" name="segitiga" value="1" id="segitiga_ada" required> 
                ...
                <div class="col-8 py-2">
                    <div class="d-flex small align-items-center">
                        <input type="radio" class="mr-1" name="dongkrak" value="1" id="dongkrak_ada" required> 
                ...
                <div class="col-8 py-2">
                    <div class="d-flex small align-items-center">
                        <input type="radio" class="mr-1" name="toolkit" value="1" id="toolkit_ada" required> 
                ...
                <div class="col-8 py-2">
                    <div class="d-flex small align-items-center">
                        <input type="radio" class="mr-1" name="gembok" value="1" id="gembok_ada" required> 
                ...
                <div class="col-8 py-2">
                    <div class="d-flex small align-items-center">
                        <input type="radio" class="mr-1" name="bongkar" value="1" id="bongkar_ada" required> 
...
<script>
    ...
    $(document).ready(function () {
        formmutasi.find('.authorization').change(function(){
            ...
            list.forEach((item,index)=>{
                table_string += '<td width="'+width+'%" class="align-bottom small" style="height: 120px"><b>'+item.employee.name+'</b><br>'+item.employee_position.name+'</td>';
            });
            table_string += '</tr>';
