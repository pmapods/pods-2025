        ...
        <div class="row mb-3">
            <div class="col-9 row">
                @php
                    ...
                    $sewa_notes .= 'Dari '.$armadaticket->salespoint->name.' ke '.$armadaticket->mutasi_form->receiver_salespoint_name."\r\n";
                    $sewa_notes .= 'Untuk PO '.$armadaticket->po_reference_number."\r\n";
                    break;
                    }
                @endphp
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{ $armadaticket->vendor_recommendation_name }}"
                            readonly>
                    </div>
                </div>
                <div class="col">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                        value="{{$armadaticket->po_reference->armada_ticket->vendor_name}}" readonly>
                                </div>
                            </div>
                        @break
                    @endswitch
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="selected_unit" id="selected_unit"
                                        value="{{ $armadaticket->po_reference->armada_ticket->armada->plate }}" readonly>
                                </div>
                            </div>
                        @break
                    @endswitch
