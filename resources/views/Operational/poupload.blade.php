    ...
    <form action="/uploadsigneddocument" method="post" enctype="multipart/form-data">
      ...
      <div class="container h-100 d-flex flex-column justify-content-center align-items-center">
          ...
          <div class="row">
                ...
                <div class="col-md-6">: {{$poupload->po->created_at->translatedFormat('d F Y (H:i)')}}</div>
                ...
                <div class="col-md-6">: <a href="/storage/{{$poupload->po->internal_signed_filepath}}" download="{{$filename}}">{{$filename}}</a></div>
                @if ($poupload->status == 1)
                  ...
                  <div class="col-md-6">: <a href="/storage/{{$poupload->filepath}}" download="{{$filename}}">{{$filename}}</a></div>
                @endif
          </div>
          ...
          <div class="text-center mt-1 d-flex flex-column">
              <div class="form-group">
                  ...
                  <input type="file" name="file" class="form-control-file form-control-lg" accept="application/pdf" required>
              </div>
