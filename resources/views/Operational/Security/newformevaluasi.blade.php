            ...
            <tbody>
                <tr>
                    ...
                    @for ($i = 0; $i < 5; $i++) <td><input type="number"
                            ...
                            data-col="{{ $i }}" placeholder="-" min="1" max="4" disabled></td>
                        @endfor
                ...
                <tr style="line-height: 30px">
                    ...
                    @for ($i = 0; $i < 5; $i++) <td><input type="number"
                            ...
                            data-row="{{ $row_count }}" data-col="{{ $i }}" min="1" max="4" disabled></td>
                        @endfor
                        @php $row_count++; @endphp
                </tr>
                @endforeach
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="input-group input-group-sm">
                                <select class="form-control form-control-sm nilai_lembaga" name="" id="">
